...
<div class="card">
	...
	<div class="card-body">
		<form action="" enctype="multipart/form-data" method="post">
			...
			<div class="mb-3">
				<input class="form-control" type="text" name="usuario" id="usuario" value="<?php echo $usuario; ?>" placeholder="Usuario" autocomplete="off" required />
			</div>

			<div class="mb-3">
				<input class="form-control" type="password" name="password" id="password" value="<?php echo $password; ?>" placeholder="Contraseña" autocomplete="off" required />
			</div>

			<div class="mb-3">
				<input class="form-control" type="email" name="correo" id="correo" value="<?php echo $correo; ?>" placeholder="Correo" autocomplete="off" required />
			</div>
